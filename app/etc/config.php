...
return [
    ...
    'modules' => [
        ...
        'Webjump_AttributeEmail' => 1,
        'Webjump_Carbono' => 1,
        'Webjump_Catalog' => 1,
        'Webjump_CategoriesAndSubcategories' => 1,
        'Webjump_CmsPageTranslator' => 1,
        'Webjump_Configuration' => 1,
        'Webjump_Cptechwidget' => 1,
        'Webjump_CustomerAttributeAddress' => 1,
        'Webjump_CustomerBr' => 1,
        'Webjump_HidePriceCatalog' => 1,
        'Webjump_OrderNotificationBrand' => 1,
        'Webjump_OrderStatus' => 1,
        'Webjump_OrganizeAttribute' => 1,
        'Webjump_PostCode' => 1,
        'Webjump_Shippinghidden' => 1,
        'Webjump_ValidateCustomerLogin' => 1,
        'Webjump_ViaCep' => 1,
        'Yotpo_Yotpo' => 1
    ],
    'admin_user' => [
